                    ...
                    <Grid columns={{ initial: "1", md: "2" }} gap="7" align="center">
                        ...
                        >
                            <Flex direction="column" gap="4" align="start">
                                ...
                                <Text
                                    size="5"
                                    color="gray"
                                    style={{ maxWidth: "480px", lineHeight: 1.5 }}
                                >
                                    A modern realtime chat experience designed to feel natural,
                                    fluid, and secure. Built for teams and communities.
                                </Text>
                        ...
                        >
                            <Box
                                ...
                                style={{ padding: 0, border: "1px solid var(--gray-a4)" }}
                            >
                                <img
                                    src="/hero.png"
                    ...
                    <Flex direction="column" gap="6">
                        ...
                        >
                            ...
                            <Text size="4" color="gray" style={{ maxWidth: "600px" }}>
                                Everything you need to stay connected, without the clutter. Designed
                                with a focus on speed, privacy, and aesthetics.
                            </Text>
                        </Flex>
                        ...
                        <Grid columns={{ initial: "1", md: "3" }} gap="4" className="bento-grid">
                            <Card
                                size="3"
                                className="bento-card col-span-md-2"
                                variant="surface"
                            ...
                            >
                                ...
                                >
                                    <Flex
                                        ...
                                        style={{ background: "var(--ruby-a3)" }}
                                    >
                                        <MorphIcon icon={Zap} size={24} color="var(--ruby-11)" />
                                    </Flex>
                                    <Heading size="5">Realtime Sync</Heading>
                                    <Text size="3" color="gray">
                                        Messages are delivered instantly using WebSockets. No
                                        polling, no delays. Experience fluid conversations that keep
                            ...
                            >
                                ...
                                >
                                    <Flex
                                        ...
                                        justify="center"
                                        className="bento-icon-wrapper"
                                        style={{ background: "var(--cyan-a3)" }}
                                    >
                                        <MorphIcon icon={Globe} size={24} color="var(--cyan-11)" />
                                    </Flex>
                                    <Heading size="5">Anywhere</Heading>
                                    <Text size="3" color="gray">
                                        Access your chats from any device. Fully responsive design
                                        that works beautifully on mobile, tablet, and desktop.
                                    </Text>
                                </Flex>
                            </Card>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Text size="3" color="gray">
                                        A gorgeous dark mode that's easy on the eyes. Seamlessly
                                        integrates with your system preferences.
                                    </Text>
                                </Flex>
                            </Card>
                            ...
                            >
                                ...
                                >
                                    <Flex
                                        ...
                                        justify="center"
                                        className="bento-icon-wrapper"
                                        style={{ background: "var(--tomato-a3)" }}
                                    >
                                        <MorphIcon
                                            icon={Shield}
                                            size={24}
                                    ...
                                    <Text size="3" color="gray">
                                        Your data is yours. Secure authentication via email OTP
                                        ensures that only you have access to your account and
                                        messages.
                                    </Text>
                                </Flex>
                            </Card>
